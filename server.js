...
app.post("/protect-pdf", upload.single("pdfFile"), async (req, res) => {
  ...
  try {
    ...
    console.log("PROTECT PDF USER ID =", userId);
    ...
    if (!profileData.is_premium) {
      ...
      if (currentUsage >= 8) {
        ...
        return res.status(403).send(
          "Daily free limit reached. Upgrade to Premium for unlimited Protect PDF conversions."
        );
    ...
    if (!usageData) {
      ...
      console.log(
        "PROTECT PDF UPDATE ERROR =",
        updateError
      );

    }

    console.log("PROTECT PDF SUCCESS");
...
app.post("/repair-pdf", upload.single("pdf"), async (req, res) => {
  try {
    ...
    console.log("REPAIR PDF USER ID =", userId);
    ...
    if (!profileData.is_premium) {
      ...
      if (currentUsage >= 8) {
        ...
        return res.status(403).send(
          "Daily free limit reached. Upgrade to Premium for unlimited Repair PDF conversions."
        );
    ...
    if (!usageData) {
      ...
      console.log(
        "REPAIR PDF UPDATE ERROR =",
        updateError
      );

    }

    console.log("REPAIR PDF SUCCESS");
...
app.post("/redact-pdf", upload.single("pdfFile"), async (req, res) => {
  ...
  try {
    ...
    console.log("REDACT PDF USER ID =", userId);
    ...
    if (!profileData.is_premium) {
      ...
      if (currentUsage >= 8) {
        ...
        return res.status(403).send(
          "Daily free limit reached. Upgrade to Premium for unlimited Redact PDF conversions."
        );
  ...
  console.log("REDACT PDF INSERT ERROR =", insertError);
  ...
  console.log("REDACT PDF UPDATE ERROR =", updateError);
...
app.post("/sign-pdf", upload.single("file"), async (req, res) => {
  try {
    ...
    console.log("SIGN PDF USER ID =", userId);
    ...
    if (!profileData.is_premium) {
      ...
      if (currentUsage >= 8) {
        ...
        return res.status(403).send(
          "Daily free limit reached. Upgrade to Premium for unlimited Sign PDF conversions."
        );
...
app.post("/pdf-forms", upload.single("file"), async (req, res) => {
  try {
    ...
    console.log("PDF FORMS USER ID =", userId);
    ...
    if (!profileData.is_premium) {
      ...
      if (currentUsage >= 8) {
        ...
        return res.status(403).send(
          "Daily free limit reached. Upgrade to Premium for unlimited PDF Forms usage."
        );
    ...
    if (!usageData) {
      ...
      console.log("PDF FORMS INSERT ERROR =", insertError);
      ...
      console.log("PDF FORMS UPDATE ERROR =", updateError);
